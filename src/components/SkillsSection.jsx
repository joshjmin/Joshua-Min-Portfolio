            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {filteredSkills.map((skill, index) => (
                        <div
                            key={index}
                            className="px-6 py-3 border-2 rounded-xl font-medium shadow-sm hover:shadow-md transition-all duration-300 cursor-default bg-card border-border text-foreground hover:border-primary hover:scale-105 hover:-translate-y-0.5 whitespace-nowrap"
                            style={{
